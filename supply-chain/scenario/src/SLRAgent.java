...
public class SLRAgent extends Agent {
    ...
    protected void setup() {
        ...
        addBehaviour(new SimplePredictionRequest());

        addBehaviour(new SimplePredictionDo());
    }
    ...
    private class SimplePredictionRequest extends CyclicBehaviour {
        public void action() {
    ...
    private class SimplePredictionDo extends CyclicBehaviour {
        ...
        public void action() {
            ...
            if (msg != null) {
                ...
                reply.setContent(slr.DoRegression(data)); 
                myAgent.send(reply);
            } else {
                block();
            }
